...
# 100,000 pv_shoestring volumes of 128 x 128 x 64 from ../config_full_pv_shoestring_v3.json (v3), ResMill 5bf93ad or later,
# on NERSC Perlmutter CPU nodes: 128 single-thread ranks per node as in v1.
# Cost from the Vista measurement of 2026-09-22 (14 s a volume on one Grace core,
# assumed 1.3x slower per core here): 506 core-hours = 3.9 node-hours,
# about 3.9 h on 1 node(s); walltime 05:30 leaves a 1.3x margin.
