...
# v2 dataset, 100,000 pv_shoestring samples from ../config_full_pv_shoestring_v2.json (ResMill 3e71977 or later),
# on NERSC Perlmutter CPU nodes: 128 single-thread ranks per node as in v1.
# Cost from the Vista measurement of 2026-09-22 (3.4 s a cube on one Grace core,
# assumed 1.3x slower per core here): 123 core-hours = 1.0 node-hours,
