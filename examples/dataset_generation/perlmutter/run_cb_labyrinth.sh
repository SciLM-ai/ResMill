...
# 100,000 cb_labyrinth volumes of 128 x 128 x 64 from ../config_full_cb_labyrinth_v3.json (v3), ResMill 5bf93ad or later,
# on NERSC Perlmutter CPU nodes: 128 single-thread ranks per node as in v1.
# Cost from the Vista measurement of 2026-09-22 (71 s a volume on one Grace core,
# assumed 1.3x slower per core here): 2,564 core-hours = 20.0 node-hours,
# about 3.3 h on 6 node(s); walltime 04:30 leaves a 1.3x margin.
