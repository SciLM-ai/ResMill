...
# 100,000 sh_distal volumes of 128 x 128 x 64 from ../config_full_sh_distal.json (128 x 128 x 64 stored whole, depth 3-16 m,
...
srun --cpu-bind=cores env -u LD_PRELOAD "$PY" -m resmill.dataset.cli examples/dataset_generation/config_full_sh_distal.json
