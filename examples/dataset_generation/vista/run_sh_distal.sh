...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 126 s per volume on one
# core -> 3,489 core-hours = 24.2 node-hours at 144 ranks per node; on 7 node(s) about 3.5 h wall,
