...
# 100,000 pv_shoestring samples from ../config_full_pv_shoestring_v2.json, ResMill 8ba8c4f, on TACC Vista gg
...
test "$(git rev-parse --short HEAD)" = 8ba8c4f || { echo "checkout ResMill 8ba8c4f first"; exit 1; }
