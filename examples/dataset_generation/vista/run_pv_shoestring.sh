...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 5 s per volume on one
# core -> 136 core-hours = 0.9 node-hours at 144 ranks per node; on 1 node(s) about 0.9 h wall,
# walltime 01:30 gives a 1.3x margin. Each rank takes every N-th job of the shuffled Sobol job list.
