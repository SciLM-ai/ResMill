...
# 100,000 pv_shoestring samples from ../config_full_pv_shoestring_v2.json, ResMill b7474f2, on TACC Vista gg
...
test "$(git rev-parse --short HEAD)" = b7474f2 || { echo "checkout ResMill b7474f2 first"; exit 1; }
