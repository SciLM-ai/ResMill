...
#SBATCH -t 03:00:00
#SBATCH -J resmill_cb_jigsaw_v2
#SBATCH -A CHE23004
#SBATCH -o logs/%x-%j.out

# 150,000 cb_jigsaw volumes of 128 x 128 x 64 from ../config_full_cb_jigsaw_v2.json (v2: uncropped, depth 3-16 m,
...
srun --cpu-bind=cores env -u LD_PRELOAD "$PY" -m resmill.dataset.cli examples/dataset_generation/config_full_cb_jigsaw_v2.json
