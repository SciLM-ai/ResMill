...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 16 s per volume on one
# core -> 662 core-hours = 4.6 node-hours at 144 ranks per node; on 2 node(s) about 2.3 h wall,
