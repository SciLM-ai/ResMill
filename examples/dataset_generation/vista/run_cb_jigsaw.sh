...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 86 s per volume on one
# core -> 3,596 core-hours = 25.0 node-hours at 144 ranks per node; on 7 node(s) about 3.6 h wall,
