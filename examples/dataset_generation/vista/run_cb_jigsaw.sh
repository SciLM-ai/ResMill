...
# 150,000 cb_jigsaw volumes of 128 x 128 x 64 from ../config_full_cb_jigsaw_v3.json (v3: uncropped, depth 3-16 m,
...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 85 s per volume on one
# core -> 3,546 core-hours = 24.6 node-hours at 144 ranks per node; on 7 node(s) about 3.5 h wall,
...
srun --cpu-bind=cores env -u LD_PRELOAD "$PY" -m resmill.dataset.cli examples/dataset_generation/config_full_cb_jigsaw_v3.json
