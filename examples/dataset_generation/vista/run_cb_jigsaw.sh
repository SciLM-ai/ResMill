...
# 150,000 cb_jigsaw samples from ../config_full_cb_jigsaw.json, ResMill 885be98, on TACC Vista gg
...
srun --cpu-bind=cores "$PY" -m resmill.dataset.cli examples/dataset_generation/config_full_cb_jigsaw.json
