...
# 100,000 cb_labyrinth volumes of 128 x 128 x 64 from ../config_full_cb_labyrinth_v3.json (v3: uncropped, depth 3-16 m,
...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 71 s per volume on one
# core -> 1,972 core-hours = 13.7 node-hours at 144 ranks per node; on 4 node(s) about 3.4 h wall,
...
srun --cpu-bind=cores env -u LD_PRELOAD "$PY" -m resmill.dataset.cli examples/dataset_generation/config_full_cb_labyrinth_v3.json
