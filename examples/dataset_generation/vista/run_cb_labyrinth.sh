...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 62 s per volume on one
# core -> 1,728 core-hours = 12.0 node-hours at 144 ranks per node; on 3 node(s) about 4.0 h wall,
