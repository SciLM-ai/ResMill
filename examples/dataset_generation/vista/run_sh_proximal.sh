...
#SBATCH -t 04:30:00
#SBATCH -J resmill_sh_proximal_v3
#SBATCH -A CHE23004
#SBATCH -o logs/%x-%j.out

# 100,000 sh_proximal volumes of 128 x 128 x 64 from ../config_full_sh_proximal_v3.json (v3: uncropped, depth 3-16 m,
...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 107 s per volume on one
# core -> 2,972 core-hours = 20.6 node-hours at 144 ranks per node; on 6 node(s) about 3.4 h wall,
...
srun --cpu-bind=cores env -u LD_PRELOAD "$PY" -m resmill.dataset.cli examples/dataset_generation/config_full_sh_proximal_v3.json
