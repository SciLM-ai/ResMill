...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 101 s per volume on one
# core -> 2,794 core-hours = 19.4 node-hours at 144 ranks per node; on 5 node(s) about 3.9 h wall,
