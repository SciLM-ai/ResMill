...
# 100,000 sh_proximal samples from ../config_full_sh_proximal.json, ResMill 885be98, on TACC Vista gg
...
test "$(git rev-parse --short HEAD)" = 885be98 || { echo "checkout ResMill 885be98 first"; exit 1; }

srun --cpu-bind=cores "$PY" -m resmill.dataset.cli examples/dataset_generation/config_full_sh_proximal.json
