...
# 150,000 delta volumes of 128 x 128 x 64 from ../config_full_delta_v3.json (v3: uncropped, depth 3-16 m,
...
srun --cpu-bind=cores env -u LD_PRELOAD "$PY" -m resmill.dataset.cli examples/dataset_generation/config_full_delta_v3.json
