...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 19 s per volume on one
# core -> 779 core-hours = 5.4 node-hours at 144 ranks per node; on 2 node(s) about 2.7 h wall,
