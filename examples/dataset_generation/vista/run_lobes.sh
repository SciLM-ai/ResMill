...
#SBATCH -t 05:30:00
#SBATCH -J resmill_lobes_v3
#SBATCH -A CHE23004
#SBATCH -o logs/%x-%j.out

# 200,000 lobes volumes of 128 x 128 x 64 from ../config_full_lobes_v3.json (v3: uncropped, depth 3-16 m,
...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 7 s per volume on one
# core -> 378 core-hours = 3.9 node-hours at 96 ranks per node; on 1 node(s) about 3.9 h wall,
...
srun --cpu-bind=cores env -u LD_PRELOAD "$PY" -m resmill.dataset.cli examples/dataset_generation/config_full_lobes_v3.json
