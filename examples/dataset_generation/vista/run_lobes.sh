...
# 200,000 lobes samples from ../config_full_lobes.json, ResMill 3e71977 or later, on TACC Vista gg
...
srun --cpu-bind=cores env -u LD_PRELOAD "$PY" -m resmill.dataset.cli examples/dataset_generation/config_full_lobes.json
