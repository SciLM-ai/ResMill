...
# Measured 2026-09-22 on the 144-volume preview with the node fully loaded: 422 s per volume on one
# core -> 11,708 core-hours = 81.3 node-hours at 144 ranks per node; on 21 node(s) about 3.9 h wall,
